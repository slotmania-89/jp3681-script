...
function createApkBox() {
    ...
    <div class="maxwin-box">
      <div class="left-panel">
        ...
        <button class="main-link" type="button" id="copyMainLinkBtn">
          urlwin.link/jp368-login
        </button>

        <div class="label">Pilih Link Alternatif:</div>

        <select id="altLink">
          <option value="https://link2.akses-terjamin.com">link2.akses-terjamin.com</option>
          <option value="https://link5.akses-terjamin.com">link5.akses-terjamin.com</option>
          <option value="https://link6.akses-terjamin.com">link6.akses-terjamin.com</option>
        </select>
  ...
  if (copyMainLinkBtn) {
    copyMainLinkBtn.addEventListener("click", function () {
      const value = "https://urlwin.link/jp368-login";
